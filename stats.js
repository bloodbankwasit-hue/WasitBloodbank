...
function printStats(){
  ...
  printHtmlDocument(`<!DOCTYPE html><html lang="ar" dir="rtl"><head><meta charset="UTF-8"><title>تقرير إحصائي</title>
  ...
  .rh-t{font-size:16px;font-weight:700}.rh-s{font-size:13px;opacity:.8;margin-top:2px}.rh-en{text-align:left;font-size:13px;opacity:.7;line-height:1.6}
  .rpt-body{padding:14px}.rs{margin-bottom:12px}.rs-t{font-size:14px;font-weight:700;color:#757575;padding:4px 8px;background:#fafafa;border-radius:4px;margin-bottom:6px}
  .rr{display:flex;justify-content:space-between;padding:4px 8px;border-bottom:1px solid #f5f5f5;font-size:14px}.rr:last-child{border-bottom:none}.rv{font-weight:700;color:#BE123C}
...
.ah-name{font-size:16px;font-weight:700;color:#1E293B;line-height:1.35}
.ah-sub{font-size:13px;color:#94A3B8;margin-top:1px}
.ah-online{display:flex;align-items:center;gap:5px;font-size:13.5px;color:#16A34A;font-weight:600;flex-shrink:0}
...
.ah-av{width:32px;height:32px;border-radius:50%;background:#BE123C;display:flex;align-items:center;justify-content:center;color:#fff;font-size:16px;font-weight:700;flex-shrink:0}
.ah-uname{font-size:15.5px;font-weight:700;color:#1E293B}
.ah-urole{font-size:13.5px;color:#64748B;margin-top:1px}
.ah-dept{font-size:14px;font-weight:700;color:#BE123C;background:#FFF1F2;border:1px solid #FECDD3;padding:3px 11px;border-radius:20px;flex-shrink:0}
...
.ptb-title{font-size:16.5px;font-weight:700;color:#1E293B}

/* 3-TAB BOTTOM NAV */
.bn-icon{font-size:27px;display:block;line-height:1}
.bn-lbl{font-size:13px;display:block;margin-top:3px;font-weight:600}
...
.wcard-icon{font-size:33px;display:block;margin-bottom:8px;line-height:1}
.wcard-name{font-size:16px;font-weight:700;color:#1E293B}
.wcard-desc{font-size:14px;color:#64748B;margin-top:2px}
.wcard-badge{display:inline-block;font-size:13px;padding:2px 9px;border-radius:20px;margin-top:6px;font-weight:700}
...
.acc-av-big{width:64px;height:64px;border-radius:50%;background:#BE123C;display:flex;align-items:center;justify-content:center;color:#fff;font-size:27px;font-weight:700;margin:0 auto 12px;border:3px solid #FECDD3}
.acc-pname{font-size:20px;font-weight:800;color:#1E293B}
.acc-psub{font-size:14px;color:#94A3B8;margin-top:4px}
.acc-prole{display:inline-block;background:#FFF1F2;color:#BE123C;font-size:14.5px;padding:4px 14px;border-radius:20px;margin-top:8px;font-weight:700;border:1px solid #FECDD3}
...
.ami-icon{width:36px;height:36px;border-radius:10px;background:#F1F5F9;display:flex;align-items:center;justify-content:center;font-size:21px;flex-shrink:0}
.ami-icon.danger{background:#FEE2E2}
.ami-text{font-size:16px;font-weight:600;color:#1E293B}
.ami-sub{font-size:14px;color:#94A3B8;margin-top:1px}
.ami-arr{margin-right:auto;color:#CBD5E1;font-size:21px;flex-shrink:0}
...
.ob-badge{background:rgba(255,255,255,.25);border-radius:20px;padding:2px 10px;font-size:14px}
...
.oqc-title{font-size:16px;font-weight:700;color:#92400E}
.oqc-sub{font-size:14px;color:#B45309;margin-top:3px}
.oqc-count{background:#92400E;color:#fff;border-radius:20px;padding:2px 9px;font-size:14px;font-weight:700}

/* BACK BUTTON */
.back-btn{
  display:none;align-items:center;gap:6px;
  background:none;border:none;cursor:pointer;
  color:#BE123C;font-size:16px;font-weight:600;
  padding:8px 16px 4px;font-family:inherit;
  -webkit-tap-highlight-color:transparent;
}
.back-btn.show{display:flex}
.back-btn-icon{font-size:21px}
...
.seq-type{font-size:15px;font-weight:700;color:#1E293B;margin-bottom:6px}
.seq-num{font-size:25px;font-weight:800;color:#BE123C;line-height:1}
.seq-range{font-size:13px;color:#94A3B8;margin-top:3px}
.seq-remain{font-size:13px;font-weight:600;margin-top:4px}
.seq-remain.ok{color:#16A34A}
.seq-remain.warn{color:#D97706}
.seq-remain.danger{color:#DC2626}
.seq-edit{position:absolute;top:8px;left:8px;background:#FFF1F2;border:none;border-radius:8px;padding:4px 8px;font-size:14px;color:#BE123C;cursor:pointer;font-family:inherit;font-weight:600}
.seq-add-btn{width:100%;padding:12px;background:#BE123C;color:#fff;border:none;border-radius:12px;font-size:17px;font-weight:700;cursor:pointer;font-family:inherit;display:flex;align-items:center;justify-content:center;gap:8px;margin-bottom:12px}
...
.ac-av{width:32px;height:32px;border-radius:50%;background:#FFF1F2;display:flex;align-items:center;justify-content:center;font-size:16px;font-weight:700;color:#BE123C;flex-shrink:0}
.ac-info .ac-name{font-size:16px;font-weight:700;color:#1E293B}
.ac-info .ac-sub{font-size:13.5px;color:#94A3B8;margin-top:1px}
...
.rc-filled-text{font-size:15.5px;color:#166534;font-weight:600}
.rc-filled-clear{background:none;border:none;color:#DC2626;font-size:15px;cursor:pointer;font-weight:600;padding:2px 6px;font-family:inherit}

/* ═══ RARE BLOOD TYPES ═══ */
.rare-wrap{display:flex;flex-direction:column;gap:12px}
.rare-search-bar{display:flex;gap:8px;align-items:center}
.rare-search-bar input{flex:1;padding:10px 14px;border:1.5px solid #EEF2F6;border-radius:12px;font-family:inherit;font-size:17px;direction:rtl}
.rare-search-bar select{padding:10px 12px;border:1.5px solid #EEF2F6;border-radius:12px;font-family:inherit;font-size:16px;background:#fff}
...
.rs-type{font-size:18px;font-weight:800;color:#BE123C}
.rs-count{font-size:14px;color:#94A3B8;margin-top:2px}
...
.rare-av{width:36px;height:36px;border-radius:50%;background:#FFF1F2;display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:800;color:#BE123C;flex-shrink:0}
.rare-info{flex:1;min-width:0}
.rare-name{font-size:16px;font-weight:700;color:#1E293B;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.rare-addr{font-size:14px;color:#94A3B8;margin-top:2px}
.rare-mob{font-size:15px;color:#BE123C;font-weight:600}
.rare-call{background:none;border:none;color:#16A34A;font-size:23px;cursor:pointer;padding:4px;flex-shrink:0}
